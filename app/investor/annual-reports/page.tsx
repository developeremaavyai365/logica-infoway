...
import { ANNUAL_REPORTS } from "@/lib/investor";

export const metadata: Metadata = {
  title: "Annual Reports | Logica Infoway",
  description: "Annual reports of Logica Infoway Limited, financial year 2019-20 through 2024-25.",
};
