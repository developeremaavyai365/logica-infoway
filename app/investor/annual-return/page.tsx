...
import { ANNUAL_RETURNS } from "@/lib/investor";

export const metadata: Metadata = {
  title: "Annual Return | Logica Infoway",
  description: "Annual returns (MGT forms) of Logica Infoway Limited, financial year 2019-20 through 2024-25.",
};
              ...
              <li key={report.url}>
                ...
                >
                  <span className="flex items-center gap-3">
                    ...
                    <span className="font-medium text-neutral-900">{report.title}</span>
                  </span>
