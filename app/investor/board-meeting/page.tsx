...
import { BOARD_MEETING_PERIODS } from "@/lib/investor";

export const metadata: Metadata = {
  title: "Board Meeting | Logica Infoway",
  description: "Notices and outcomes of board meetings of Logica Infoway Limited, by fiscal year.",
};
      ...
      <Section className="pb-16 pt-28 sm:pt-32">
        <Container size="narrow">
          ...
          <ul className="mt-10 divide-y divide-neutral-200 rounded-2xl border border-neutral-200">
            {BOARD_MEETING_PERIODS.map((period) => (
              <li key={period.url}>
                <a
                  href={period.url}
                  target="_blank"
