...
import { FINANCIAL_RESULTS } from "@/lib/investor";

export const metadata: Metadata = {
  title: "Financial Results | Logica Infoway",
  description: "Half-yearly and annual financial results of Logica Infoway Limited.",
};
