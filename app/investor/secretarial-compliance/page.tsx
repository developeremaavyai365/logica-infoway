...
import { SECRETARIAL_COMPLIANCE } from "@/lib/investor";

export const metadata: Metadata = {
  title: "Secretarial Compliance | Logica Infoway",
  description: "Secretarial audit reports of Logica Infoway Limited.",
};
      ...
      <Section className="pb-16 pt-28 sm:pt-32">
        <Container size="narrow">
          ...
          <ul className="mt-10 divide-y divide-neutral-200 rounded-2xl border border-neutral-200">
            {SECRETARIAL_COMPLIANCE.map((report) => (
              <li key={report.url}>
                <a
                  href={report.url}
                  target="_blank"
