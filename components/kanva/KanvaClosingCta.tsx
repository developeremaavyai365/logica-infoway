...
export function KanvaClosingCta() {
  return (
    <section className="relative overflow-hidden border-t border-neutral-200 bg-gradient-to-br from-violet-200 via-violet-100 to-fuchsia-100 px-6 py-24 text-center lg:py-32">
