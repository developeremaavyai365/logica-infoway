...
// GlareHover — from ReactBits (reactbits.dev). A diagonal glare sweeps across
// the surface on hover. Used here as a premium sheen over the product stage.
...
const GlareHover: React.FC<GlareHoverProps> = ({
  ...
  const animateIn = () => {
    ...
    // Force reflow so the following transition runs.
